            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <div class="d-md-flex">
                    <ol class="breadcrumb ms-auto">
                        <li><a href="#" class="fw-normal">Kontak</a></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="white-box">
                <div class="d-md-flex mb-3">
                    <a href="{{ url('/admin-manage-contact/add') }}" class="btn btn-primary text-white">Tambah</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning text-white me-1"
                                        href="{{ url('/admin-manage-contact/edit', $item->id) }}">Edit</a>
                                    <form onsubmit="return confirm('Data akan dihapus?')" class='d-inline'
                                        action="{{ url('/admin-manage-contact', $item->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
